...
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-Visit_Now-0284c7?style=for-the-badge&logoColor=white)](https://foysalhridoy.github.io/ICEroutine/)
[![GitHub Stars](https://img.shields.io/github/stars/foysalhridoy/ICEroutine?style=for-the-badge&color=fbbf24&logo=github)](https://github.com/foysalhridoy/ICEroutine/stargazers)
[![MIT License](https://img.shields.io/badge/License-MIT-22c55e?style=for-the-badge)](LICENSE)
[![Made with Love](https://img.shields.io/badge/Made_with-❤️-ef4444?style=for-the-badge)](https://github.com/foysalhridoy)

<br/>

![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=22&pause=1200&color=0284C7&center=true&vCenter=true&width=650&lines=Select+Batch+%E2%86%92+See+Full+Routine+%E2%9A%A1;Real-Time+Class+Status+%F0%9F%9F%A2+Live+Now;Export+as+Image+%2F+PDF+%2F+WhatsApp+Text;Faculty+%26+Room+Schedules+at+a+Glance)
...
![html2canvas](https://img.shields.io/badge/html2canvas-0284c7?style=flat-square&logoColor=white)
...
```mermaid
graph TD
    A[Google Sheets / XLSX / CSV] -->|parser.js| B[Parsed Routine Data]
    B --> C[app.js Controller]
    C --> D[Batch Timetable View]
    C --> E[Master Matrix View]
    C --> F[Faculty View]
    C --> G[Room View]
    C -->|Real-time clock| H[Live Class Status Badges]
    D -->|html2canvas| I[PNG Export]
    D -->|window.print| J[PDF Export]
    D -->|Clipboard API| K[Text Copy]
    C <-->|Optional| L[Firebase Firestore Sync]
```
